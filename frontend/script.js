...
// DOM Elements
let clinicalForm, predictBtn, analyticsPanel, loadingOverlay, aiFab, aiChatWindow, chatClose, chatMessages, chatInputField, sendBtn, themeToggle, logoutBtn, refreshLocationBtn, currentLocationElement, refreshHospitalsBtn, hospitalList;
...
function initializeDOMElements() {
    ...
    currentLocationElement = document.getElementById('current-location');
    refreshHospitalsBtn = document.getElementById('refresh-hospitals');
...
function setupEventListeners() {
    ...
    // Header buttons - make them interactive
...
function callHospital(phone) {
    ...
    if (typeof addChatMessage === 'function') {
        ...
        console.log(`Dialing hospital at ${phone}`);
    }
}
